...
export default function ContractHero({ selectedCount, studentHours, modality, onModalityChange, simulatedDay, onSimulatedDayChange, user }) {
  ...
  return (
    <section className="contract-hero" aria-labelledby="welcome-title">
      <div className="hero-copy">
        ...
        <h1 id="welcome-title">Bienvenido de nuevo, {user.name}</h1>
